...
## Project Structure
    ...
    ├── new_atlantis_crysta_28774  # Django project configurations
...
1. Clone this repo and `cd new_atlantis_crysta_28774`
...
2. Clone this repo and `cd new_atlantis_crysta_28774`
